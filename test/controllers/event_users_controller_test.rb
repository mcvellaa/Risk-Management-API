...
class EventUsersControllerTest < ActionController::TestCase
  ...
  test "should create event_user" do
    assert_difference('EventUser.count') do
      post :create, event_user: { event_id: @event_user.event_id, last_location: @event_user.last_location, location_datetime: @event_user.location_datetime, role: @event_user.role, user_id: @event_user.user_id }
    end
  ...
  test "should update event_user" do
    patch :update, id: @event_user, event_user: { event_id: @event_user.event_id, last_location: @event_user.last_location, location_datetime: @event_user.location_datetime, role: @event_user.role, user_id: @event_user.user_id }
    assert_redirected_to event_user_path(assigns(:event_user))
  end
