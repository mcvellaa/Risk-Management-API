...
class CheckOutsControllerTest < ActionController::TestCase
  ...
  test "should create check_out" do
    assert_difference('CheckOut.count') do
      post :create, check_out: { invitation_id: @check_out.invitation_id, time: @check_out.time, user_id: @check_out.user_id }
    end
  ...
  test "should update check_out" do
    patch :update, id: @check_out, check_out: { invitation_id: @check_out.invitation_id, time: @check_out.time, user_id: @check_out.user_id }
    assert_redirected_to check_out_path(assigns(:check_out))
  end
