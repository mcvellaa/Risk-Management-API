...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { event_id: @datum.event_id, question_id: @datum.question_id, response: @datum.response, user_id: @datum.user_id }
    end
  ...
  test "should update datum" do
    patch :update, id: @datum, datum: { event_id: @datum.event_id, question_id: @datum.question_id, response: @datum.response, user_id: @datum.user_id }
    assert_redirected_to datum_path(assigns(:datum))
  end
