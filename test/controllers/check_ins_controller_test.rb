...
class CheckInsControllerTest < ActionController::TestCase
  ...
  test "should create check_in" do
    assert_difference('CheckIn.count') do
      post :create, check_in: { invitation_id: @check_in.invitation_id, time: @check_in.time, user_id: @check_in.user_id }
    end
  ...
  test "should update check_in" do
    patch :update, id: @check_in, check_in: { invitation_id: @check_in.invitation_id, time: @check_in.time, user_id: @check_in.user_id }
    assert_redirected_to check_in_path(assigns(:check_in))
  end
